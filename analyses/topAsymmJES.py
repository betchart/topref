...
class topAsymmJES(supy.analysis) :
    ...
    def listOfSampleDictionaries(self) : return [getattr(samples,item) for item in ['lepton406_fnal', 'top119_fnal', 'ewk119_fnal']]

    @staticmethod
    def muons(suffix="") :     return [f+suffix for f in ['Mu.A.1','Mu.B.1','Mu.C.1','Mu.D.1']]
    @staticmethod
    def electrons(suffix="") : return [f+suffix for f in ['El.A.1','El.B.1','El.C.1','El.D.1']]
    @staticmethod
    def jsonFiles() :
        return ['lumi/json/A_JSON.txt',
