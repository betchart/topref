...
class topSync(supy.analysis) :
    ...
    def listOfSampleDictionaries(self) : return [samples.top112]
    ...
    def listOfSteps(self,pars) :
        ...
        return [
            ...
            supy.steps.filters.multiplicity('P4'.join(lepix), max=1),
            supy.steps.filters.multiplicity('P4'.join(olepix), max=0),
