...
class topAsymm(supy.analysis) :
    ...
    def skimStats(self,org) :
        ...
        grab = (['lumiHisto','xsHisto','allweighted','2_x_y','fitTopPtOverSumPt_triD','fitTopTanhRapiditySum_triD','jetPt_triD','jetMoments2Sum_triD']+#,'fitTopTanhAvgRapidity_triD','fitTopTanhAvgAbsRapidity_triD'] +
