...
elMuLoc = [
    ({"Mu": 809.3793,"El": 809.3793}, "v119/Single%s.Run2012A-13Jul2012-v1.AOD"),
    ({"Mu":  82.1357,"El":  82.1357}, "v119/Single%s.Run2012A-recover-06Aug2012-v1.AOD"),
    ({"Mu":4403.7631,"El":4396.6948}, "v119/Single%s.Run2012B-13Jul2012-v1.AOD"),
    ({"Mu": 490.5101,"El": 492.5227}, "v119/Single%s.Run2012C-PromptReco-v1.AOD"),
    ({"Mu":6396.9964,"El":6400.9605}, "v119/Single%s.Run2012C-PromptReco-v2.AOD"),
    ({"Mu": 134.2416,"El": 134.2416}, "v119/Single%s.Run2012C-EcalRecover_11Dec2012-v1.AOD"),
    ({"Mu":7273.7043,"El":7273.1408}, "v119/Single%s.Run2012D-PromptReco-v1.AOD")
    ]
